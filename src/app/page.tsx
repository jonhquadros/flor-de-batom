          ...
          <div className="container mx-auto px-4 mt-6">
            <div className="relative rounded-[2.5rem] overflow-hidden bg-primary text-white p-8 md:p-16 min-h-[420px] flex flex-col items-center justify-center text-center space-y-8 shadow-2xl shadow-primary/10">
              ...
              <div className="relative mt-8 group z-10">
                <div className="w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden ring-[6px] ring-white shadow-2xl transition-transform group-hover:scale-105 duration-500 bg-white">
                  <Image src={LOGO_URL} alt="Logo" fill className="object-cover rounded-full" />
                </div>
              </div>
            </div>
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <Card key={product.id} className={`group relative border-none bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 ${esgotado ? 'opacity-70 grayscale-[0.5]' : ''}`}>
                    <div className="relative aspect-square overflow-hidden bg-muted ring-4 ring-white rounded-[1.8rem] m-1 shadow-sm">
