        ...
        <Card className="border-none shadow-sm hover:shadow-md transition-all group overflow-hidden">
          <CardContent className="p-6">
            ...
            <div className="mt-4 space-y-1">
              ...
              <h3 className="text-xl md:text-2xl font-poppins font-semibold text-foreground">{stats?.orderCount} <span className="text-[10px] font-normal text-muted-foreground ml-1">pedidos</span></h3>
        ...
        <Card className="border-none shadow-sm hover:shadow-md transition-all group overflow-hidden">
          <CardContent className="p-6">
            ...
            <div className="mt-4 space-y-1">
              ...
              <h3 className="text-xl md:text-2xl font-poppins font-semibold text-foreground">{stats?.itemsSoldToday} <span className="text-[10px] font-normal text-muted-foreground ml-1">hoje</span></h3>
        ...
        <Card className="border-none shadow-sm hover:shadow-md transition-all group overflow-hidden">
          <CardContent className="p-6">
            ...
            <div className="mt-4 space-y-1">
              ...
              <h3 className="text-xl md:text-2xl font-poppins font-semibold text-foreground">R$ {(stats?.orderCount! > 0 ? stats?.currentRevenue! / stats?.orderCount! : 0).toFixed(2)}</h3>
